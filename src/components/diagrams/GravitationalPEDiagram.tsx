  ...
  return (
    <figure className="concept-diagram" aria-labelledby="gpe-diagram-caption">
      <svg viewBox="0 0 360 190" className="concept-diagram__svg" role="img" aria-hidden="true">
        ...
        <text x="92" y="111" textAnchor="middle" fill="#7c3aed" fontSize="9" fontWeight="700" fontFamily="system-ui">PE<tspan dy="2" fontSize="7">g</tspan></text>
        ...
        <text x="254" y="32" textAnchor="middle" fill="#fff" fontSize="9" fontWeight="700" fontFamily="system-ui">PE<tspan dy="2" fontSize="7">g</tspan></text>
      </svg>
      <figcaption id="gpe-diagram-caption" className="concept-diagram__caption">
        Lift the same object higher → more gravitational PE. PE<sub>g</sub> grows straight with height.
      </figcaption>
    </figure>
  )
}
