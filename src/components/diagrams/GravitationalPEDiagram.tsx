  ...
  return (
    <figure className="concept-diagram" aria-labelledby="gpe-diagram-caption">
      <svg viewBox="0 0 360 190" className="concept-diagram__svg" role="img" aria-hidden="true">
        ...
        <text x="92" y="111" textAnchor="middle" fill="#7c3aed" fontSize="9" fontWeight="700" fontFamily="system-ui">PE_g</text>
        ...
        <text x="254" y="32" textAnchor="middle" fill="#fff" fontSize="9" fontWeight="700" fontFamily="system-ui">PE_g</text>
      </svg>
      <figcaption id="gpe-diagram-caption" className="concept-diagram__caption">
        Lift the same object higher → more gravitational PE. PE_g grows straight with height.
      </figcaption>
    </figure>
  )
}
