  ...
  return (
    <figure className="concept-diagram" aria-labelledby="epe-diagram-caption">
      <svg viewBox="0 0 360 180" className="concept-diagram__svg" role="img" aria-hidden="true">
        ...
        <text x="150" y="60" textAnchor="middle" fill="#db2777" fontSize="8" fontWeight="700" fontFamily="system-ui">U_s</text>
        ...
        <text x="150" y="134" textAnchor="middle" fill="#fff" fontSize="8" fontWeight="700" fontFamily="system-ui">4×U_s</text>
      </svg>
